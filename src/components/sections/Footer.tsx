...
const Footer = () => {
    ...
    const email = "mailto:james@jamesrobionyrogers.com"
    ...
    return (
        <section className="flex flex-col gap-4 px-4 lg:px-8">
            <div className="mt-auto mb-4 px-4 lg:px-8 lg:mb-8 flex justify-between items-center gap-8" >
                ...
                <a href={linkedIn} target="_blank" className="text-blue-400 font-semibold text-lg sm:text-xl lg:text-2xl hover:underline">LinkedIn</a>
                <a href={github} target="_blank" className="text-blue-400 font-semibold text-lg sm:text-xl lg:text-2xl hover:underline">GitHub</a>
            </div>
        </section>
    )
}
